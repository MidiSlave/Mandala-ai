...
import { Settings2, X, Hand, Maximize, Shuffle, Download, Play, Pause, Layers, Sparkles, Palette, Maximize2, Minimize2 } from 'lucide-react';
...
import type { ColorTheme, AppConfig, PatternMode } from './config/types';
